  ...
  <div class="inner">
    ...
    <nav class="menu">
        <ul>
          ...
          <li>
            <a class="power-freak" href="https://www.instagram.com/la_testouille/" title=""><img class="insta" src="assets/images/insta.svg" alt="Logo INSTAGRAM" height="25" /></a>
          </li>
          <li>
            <a class="power-freak" href="about.php" title="">ABOUT</a>
          </li>
          <li>
